...
- (void)viewDidLoad {
    ...
    [self.view addSubview:[self creationToolBar]];


}

#pragma mark - Creacion ToolBar y Metodos de los botones de la barra de navegación inferior

- (UIToolbar *) creationToolBar {
    // Creacion de la barra de herramientas

    UIToolbar *toolbar = [[UIToolbar alloc] init];
    toolbar.frame = CGRectMake(0, self.view.frame.size.width - 44, self.view.frame.size.height, 44);
